...
public class TestBase {
	...
	{
		ExtentSparkReporter sparkreporter = new ExtentSparkReporter("reportredbus.html");
	...
	{
		extentreports.flush();
		Desktop.getDesktop().browse(new File("reportredbus.html").toURI());
	}
